...
import PreviewStudent from '@/components/PreviewStudent.vue';
import AddStudentModal from '@/components/AddStudents.vue';
import UpdateStudentModal from '@/components/UpdateStudent.vue';
...
const isModalStudents = ref(false)
function toggleStudentModal(isNew) {
  isModalStudents.value = !isModalStudents.value
}
const step = ref(1)
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="flex-1 flex items-center space-x-2">
                        ...
                        <h5 class="text-gray-500 dark:text-gray-400 ml-1">1-10 (100)</h5>
                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900  dark:text-gray-400">123456789</td>
                                <td class="px-4 py-3">
                                    <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Grade V</span>
                                </td>
                                <td class="px-4 py-3 font-medium text-gray-900  dark:text-white">14</td>
                                <td class="px-4 py-3 font-medium text-gray-900  dark:text-white">male</td>
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900  dark:text-white">just now</td>
                                <td class="px-4 py-3 font-medium text-gray-900  dark:text-white">
...
<!-- End block -->
    <AddStudentModal id="createProductModal" tabindex="-1" aria-hidden="true" class=" hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-5rem)] md:h-full"></AddStudentModal>
<!-- drawer component -->
    <UpdateStudentModal id="drawer-update-product" class="fixed top-0 left-0 z-50 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true"></UpdateStudentModal>
    <!-- Preview Drawer -->
    <PreviewStudent id="drawer-read-product-advanced" class="overflow-y-auto fixed top-0 left-0 z-40 p-4 w-full max-w-lg h-screen bg-white transition-transform -translate-x-full dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true"></PreviewStudent>
<!-- Delete Modal -->
    <DeleteModal id="delete-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"></DeleteModal>
</template>
<style scoped>
